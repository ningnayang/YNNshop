...
<div class="header w1210 bc mt15">
        ...
        <div class="search fl">
            <div class="search_form">
                ...
                <form action="./index.php" name="serarch" method="get" class="fl">
                    <input type="hidden" class="txt"  name="r" value="list/search" />
                    <input type="text" class="txt"  name="keywords" value="请输入商品关键字" />
                ...
                <dd>
                    ...
                    <div class="uclist mt10">
                        <ul class="list1 fl">
                            <li><a href="">用户信息></a></li>
                            <li><a href="">我的订单></a></li>
                            <li><a href="<?/*=\yii\helpers\Url::to(['member/address','id'=>2])*/?>">收货地址></a></li>
                            <li><a href="">我的收藏></a></li>
                        </ul>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                <?php require '../views/site/category.php'?>
                <!--<div class="cat">
