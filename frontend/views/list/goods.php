    ...
    <div class="logo w1210">
        ...
        <div class="search fl">
            <div class="search_form">
                ...
                <form action="<?=\yii\helpers\Url::to(['list/index'])?>" name="serarch" method="get" class="fl">
...
<div class="main w1210 mt10 bc">
    ...
    <!-- 商品信息内容 start -->
    <div class="goods_content fl mt10 ml10" id="<?=$goods->id?>">
        <!-- 商品概要信息 start -->
        <div class="summary">
            <h3><strong><?=$goodsIntro->content?></strong></h3>

            <!-- 图片预览区域 start -->
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$first?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$first?>" alt=""  />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$first?>',largeimage: '<?=$first?>'}"><img src="<?=$first?>"></a>
                            </li>
                            <?php foreach($goodsGallery as $pic):?>
                            <li>
                                <a  href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$pic->path?>',largeimage: '<?=$pic->path?>'}"><img src="<?=$pic->path?>"></a>
                            </li>
                            <?php endforeach?>
                       <!-- <li>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有<?=$views?>人浏览)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
                    ...
                    <ul>
                        ...
                        <li>
                            <dl>
                                <dt>&nbsp;</dt>
                                <dd>
                                    <input type="hidden" name="r" value="list/add-to-cart"/><!--路由-->
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            ...
                            <li><span>商品编号：</span><?=$goods->sn?></li>
                            <li><span>品牌：</span><?=$options[$goods->brand_id]?></li>
...
<script type="text/javascript">
    ...
    $(".goods_content fl mt10 ml10").load(function(){
        var id=$(this).attr('id');
        console.log(id);
    })
</script>
